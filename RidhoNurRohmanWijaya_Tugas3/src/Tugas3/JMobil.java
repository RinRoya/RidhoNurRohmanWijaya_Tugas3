 ...
 * @author OWNER
 */
public class JMobil extends javax.swing.JFrame {
    ...
    private void hasilActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hasilActionPerformed
        ...
        try {
            ...
            JMobilHasil m = new JMobilHasil();
            m.setTipeKendaraan(tipe.getText());
            m.setKapasitasMesin(Integer.parseInt(kapasitas.getText()));
            m.setBahanBakar(Float.parseFloat(bahan.getText()));
            m.setIdKendaraan(Integer.parseInt(id.getText()));
            m.setJarakTempuhAwal(Float.parseFloat(awal.getText()));
            m.setJarakTempuh(Float.parseFloat(akhir.getText()));
            m.perhitungan();
            m.setVisible(true);
            this.dispose();
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JMobil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
